<script module lang="ts">
	...
	export const iconPaths: Record<IconName, string> = {
		'cursor-mode': `<path d="m4 4 7 16 2.5-6.5L20 11z"/>`,
		star: `<path d="M11.5 2.6a.55.55 0 0 1 1 0l2.4 5a.55.55 0 0 0 .42.3l5.4.8a.55.55 0 0 1 .3.94l-3.9 3.85a.55.55 0 0 0-.16.48l.92 5.44a.55.55 0 0 1-.8.58l-4.83-2.56a.55.55 0 0 0-.5 0L6.92 20a.55.55 0 0 1-.8-.58l.92-5.44a.55.55 0 0 0-.16-.48l-3.9-3.85a.55.55 0 0 1 .3-.94l5.4-.8a.55.55 0 0 0 .42-.3Z"/>`,
		'star-filled': `<g fill="currentColor"><path d="M11.5 2.6a.55.55 0 0 1 1 0l2.4 5a.55.55 0 0 0 .42.3l5.4.8a.55.55 0 0 1 .3.94l-3.9 3.85a.55.55 0 0 0-.16.48l.92 5.44a.55.55 0 0 1-.8.58l-4.83-2.56a.55.55 0 0 0-.5 0L6.92 20a.55.55 0 0 1-.8-.58l.92-5.44a.55.55 0 0 0-.16-.48l-3.9-3.85a.55.55 0 0 1 .3-.94l5.4-.8a.55.55 0 0 0 .42-.3Z"/></g>`,
		...
		key: `<path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4"/><path d="m21 2-9.6 9.6"/><circle cx="7.5" cy="16.5" r="5.5"/>`,
		eye: `<path d="M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0"/><circle cx="12" cy="12" r="3"/>`,
		'eye-off': `<path d="M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49"/><path d="M14.084 14.158a3 3 0 0 1-4.242-4.242"/><path d="M17.479 17.499A10.75 10.75 0 0 1 2.062 12.35a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 2.898-4.245"/><line x1="2" x2="22" y1="2" y2="22"/>`,
